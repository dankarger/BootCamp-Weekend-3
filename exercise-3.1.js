function nb_year(p0,percent,aug,p) {
    //count variable to count years need to reach the goal
    let count=0;
    ...
    function recursive(p1) {
        //checking if the goal has been reach, if yes returning the count value
        if(p1>=p) {
            return count;
        }
        count +=1;
        //Making the population growth calculation
